...
use super::dto::{GetAssignmentEntryDTO, GetAssignmnetEntryMesssage};
        ...
        Some(user) => {
            ...
            match assignment_entry_option {
                Some(assignment_entry) => {
                    ...
                    Ok(HttpResponse::Ok().json(GetAssignmnetEntryMesssage { message: "Fetched entry".to_string(), entry: assignment_entry }))
                },
